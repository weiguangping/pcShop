<template>
  <div>
              ...
              <li v-for="(item,index) in cartList" :key="index">
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <a href="javascipt:;" class="checkbox-btn item-check-btn" :class="item.checked==1?'check':''" @click="editCart('checked',item)">
          ...
          <div class="cart-foot-inner">
            ...
            <div class="cart-foot-r">
              <div class="item-total">
                Item total: <span class="total-price">{{totlaPrice | currency('￥')}}</span>
              </div>
              <div class="btn-wrap">
    ...
    <modal :mdShow="modelConfirm" v-on:close="closeModal">
  ...
  export default{
    ...
    methods: {
      ...
      toggleCheckAll () {
        ...
        this.$ajax.post('/api/users/editCheckAll', {
          checkAll: flag
        }).then(response => {
      ...
      delCart () {
        this.$ajax.post('/api/users/cartDel', {
      ...
      init () {
        this.$ajax.get('/api/users/cartList').then((response) => {
          let res = response.data
          if (res.status === '1') {
